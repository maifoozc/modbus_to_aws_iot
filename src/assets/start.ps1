...
& $python3 aws-iot-device-sdk-python-v2\samples\pubsub.py --endpoint a2elcji7bmbmdl-ats.iot.ap-south-1.amazonaws.com --ca_file root-CA.crt --cert SULA_site.cert.pem --key SULA_site.private.key --client_id basicPubSub --topic sdk/test/python --count 0